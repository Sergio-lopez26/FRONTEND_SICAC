                ...
                <div className="collapse navbar-collapse text-center" id="plegable">
                    ...
                    <ul className="navbar-nav me-lg-auto mb-3 mb-lg-0 w-100 w-lg-auto">
                        ...
                        <li className="nav-item dropdown">
                            <a className={`nav-link dropdown-toggle active ${menuPacientes ? 'show' : ''}`} href="#" id="dropPacientes" role="button" 
                            aria-expanded={menuPacientes} onClick={togglePacientes}>
                                Pacientes
                            </a>
                            <ul className={`dropdown-menu text-center text-lg-start ${menuPacientes ? 'show' : ''}`} aria-labelledby="dropPacientes" 
                            style={{ display: menuPacientes ? 'block' : 'none' }}> 
                                <li>
                                    <Link to='/Pacientes' className="dropdown-item" onClick={cerrarMenu}>Gestionar Pacientes</Link>
                                </li>
                                <li>
                                    <Link to='/RegistrarPaciente' className="dropdown-item" onClick={cerrarMenu}>Registrar Paciente</Link>
                                </li>
                            </ul>
                        </li>
