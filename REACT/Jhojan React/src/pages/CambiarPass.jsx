...
import '../styles/stylesRecuperarPass.css'
        ...
        <div className="cambio-page">
            ...
            <div className="modal fade" id="precaucion" tabIndex="-1" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" style={{maxWidth: "380px"}}>
                    ...
                    <p className="text-muted mb-4">Estimado Usuarios. La contraseña debe tener mínimo 8 caractéres</p>
            ...
            <div className="modal fade" id="noCoincide" tabIndex="-1" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" style={{maxWidth: "380px"}}>
                    ...
                    <p className="text-muted mb-4">Estimado Usuarios. La confirmación de la contraseña no coincide</p>
            ...
            <div className="modal fade" id="exito" tabIndex="-1" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" style={{maxWidth: "380px"}}>
                    ...
                    <p className="text-muted mb-4">Estimado Usuarios. Su contraseña ha sido actualizada en el sistema</p>
